...
def test_event_queue_add_no_duplicates(queue_with_events_fixture):
    """Tests that every event was added to the queue and every item has an
    event.
    """
    _, s, eq = queue_with_events_fixture
...
@pytest.fixture
def sql_queue_with_events_fixture():
    """Fixture to create queue with events for testing.
    """
    q = json_sql_queue()
    s = SqlEventStore()
...
def test_event_queue_add_sql(sql_queue_with_events_fixture):
    """Tests that every event was added to the queue and every item has an
    event.
    """
    _, s, eq = sql_queue_with_events_fixture
...
def test_event_queue_add_no_duplicates_sql(sql_queue_with_events_fixture):
    """Tests that every event was added to the queue and every item has an
    event.
    """
    _, s, eq = sql_queue_with_events_fixture
...
def test_event_queue_lifecycle_sql(sql_queue_with_events_fixture):
    """Test event queue lifestyle works as expected.
    """
    _, s, eq = sql_queue_with_events_fixture
